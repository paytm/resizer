...
//    }
//
// This package has been update for elapsed time. In original package the elapsed time was in nanoseconds
// and hence the allowance not reduced to required value of less than 1.
// Also we are checking for rate limit per second so it has to be in seconds instead of nano seconds.
